...
SymbolTableEntry::SymbolTableEntry()
    : Partition(0, 0), m_name(0), m_info(0), m_other(0), m_shndx(0), m_value(0), m_size(0)
{
}

SymbolTableEntry::SymbolTableEntry(std::ifstream &inELFStream, size_t offset, bool lsb)
    : Partition(offset, PARTITION_SYMTAB_ENTRY_SIZE)
{
...
SymbolTable::SymbolTable()
    : Partition(0, 0), m_locNumEntries(0), m_entries(nullptr)
{
}

SymbolTable::SymbolTable(std::ifstream &inELFStream, size_t offset,
                             size_t size, bool lsb)
    : Partition(offset, size), m_locNumEntries(size / PARTITION_SYMTAB_ENTRY_SIZE),
