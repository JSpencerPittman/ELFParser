...
SymbolTable::SymbolTable()
    : m_locOffset(0), m_locNumEntries(0), m_entries(nullptr)
{
}

SymbolTable::SymbolTable(std::ifstream &inELFStream, size_t offset,
                             size_t sectionSize, bool lsb)
    : m_locOffset(offset), m_locNumEntries(sectionSize / SYMTAB_ENTRY_SIZE),
    m_locEntrySize(SYMTAB_ENTRY_SIZE), m_entries(nullptr)
{
